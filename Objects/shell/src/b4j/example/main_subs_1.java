...
Debug.ShouldStop(128);
 BA.debugLineNum = 41;BA.debugLine="Log(\"Clicked \" & SLRadioButton_Static.Cast(Sender";
Debug.ShouldStop(256);
main.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Clicked "),main._slradiobutton_static.runMethod(false,"_cast",(Object)((main.__c.runMethod(false,"Sender",main.ba)))).runClassMethod (b4j.example.slradiobutton.class, "_getselected"))));
